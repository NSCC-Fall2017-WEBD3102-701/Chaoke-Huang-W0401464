...
public class InvoiceBean {
    ...
    public String getLastIDRequest() throws IOException {
        GetRequest request = new GetRequest();
        String response = request.run("http://localhost:8080/myapp/invoices/lastID");
        Gson gson = new Gson();
    ...
    public String addInvoice() throws IOException {
        ...
        String invoiceNoInput = getLastIDRequest();
        ...
        FacesContext.getCurrentInstance().getExternalContext().getFlash().put("feedback","#" + invoice.invoiceNo +" was successfully added");
        return "invoices.xhtmlfaces-redirect=true";
    ...
    public String updateInvoiceRequest() throws IOException {
        ...
        //ExternalContext context = FacesContext.getCurrentInstance().getExternalContext();
       // context.redirect("http://localhost:8000/invoices.xhtml");
        FacesContext.getCurrentInstance().getExternalContext().getFlash().put("feedback","#" +editableInvoice.invoiceNo + " invoice was successfully updated");
        return "invoices.xhtmlfaces-redirect=true";
